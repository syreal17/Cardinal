...
n=$RANDOM
find ../../../corpora/ -wholename */$1.*.cpc.chain > edits.$n.txt
find ../../../corpora/ -wholename */$2.*.cpc.chain >> edits.$n.txt
python ../../dev/similarity/editdistance/edit_distance.py `cat edits.$n.txt` > report.$n.txt
