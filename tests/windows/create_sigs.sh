...
find ../../../corpora/ -name *$1*.elf -exec idaw64.exe -A -S"../../dev/feature_extraction/benchmarks/ida_bbcp.py" {} \;
find ../../../corpora/ -name *$1*.bbcp.feature -exec /cygdrive/c/Python27/python.exe ../../dev/similarity/bloom-jaccard/to_big_bloom.py {} \;